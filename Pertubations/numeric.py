...
class Column(Pertubation):
    ...
    def __init__(self, X_train, numerical_column, categorical_column=None):
...
class Scale(Pertubation):
    ...
    def __init__(self, X_train, numerical_column, categorical_column=None, fraction=0.3, scaler=10):
